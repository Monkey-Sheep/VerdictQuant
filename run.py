...
def _launch_detached_subprocess() -> None:
    """Start VerdictQuant in a separate process so the IDE kernel stays alive."""
...
def _print_embedded_console_help() -> None:
    msg = (
        "\n"
        "══════════════════════════════════════════════════════════════\n"
        "  VerdictQuant 是 PyQt6 桌面程序，不能在 Spyder/Jupyter 内核里直接 %runfile。\n"
