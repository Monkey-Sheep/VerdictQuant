...
# VerdictQuant timeframe → AkShare minute period (stock_zh_a_hist_min_em)
...
class AkShareSource(DataSource):
    ...
    def __init__(self) -> None:
        ...
        self._baostock_fallback_requested: bool = False

    def enable_baostock_fallback(self) -> None:
        """Enable the installed Baostock source when East Money is unavailable."""
        self._baostock_fallback_requested = True
    ...
    def connect(self) -> None:
        ...
        env_fallback = os.environ.get("PA_AGENT_BAOSTOCK_FALLBACK", "").strip() in (
            "1",
            "true",
            "yes",
        )
        if self._baostock_fallback_requested or env_fallback:
            try:
