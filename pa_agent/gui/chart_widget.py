...
class ChartWidget(pg.PlotWidget):
    ...
    def viewportEvent(self, ev):  # noqa: N802
        ...
        """
        if self.__dict__.get("_shutting_down", False):
            ev.accept()
            return True
    ...
    def shutdown(self) -> None:
        """Stop redraw work before the parent window destroys the plot scene."""
        ...
        try:
            ...
            # Qt may already have destroyed the C++ viewport during process exit.
            pass
